...
abstract class $TipModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String part, String context});
}
...
class _$_TipModel implements _TipModel {
  _$_TipModel({this.part = '', this.context = ''});
  ...
  @override
  String toString() {
    return 'TipModel(part: $part, context: $context)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, part, context);
...
abstract class _TipModel implements TipModel {
  factory _TipModel({final String part, final String context}) = _$_TipModel;
